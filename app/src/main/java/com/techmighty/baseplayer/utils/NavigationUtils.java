...
package com.techmighty.baseplayer.utils;
...
import com.techmighty.baseplayer.activities.MainActivity;
import com.techmighty.baseplayer.activities.NowPlayingActivity;
import com.techmighty.baseplayer.activities.PlaylistDetailActivity;
import com.techmighty.baseplayer.activities.SearchActivity;
import com.techmighty.baseplayer.activities.SettingsActivity;
...
import com.techmighty.baseplayer.nowplaying.BasePlayer1;
import com.techmighty.baseplayer.nowplaying.BasePlayer2;
import com.techmighty.baseplayer.nowplaying.BasePlayer3;
import com.techmighty.baseplayer.nowplaying.BasePlayer4;
...
public class NavigationUtils {
    ...
    public static void navigateToAlbum(Activity context, long albumID, Pair<View, String> transitionViews) {
        ...
        if (BasePlayerUtils.isLollipop() && transitionViews != null && PreferencesUtility.getInstance(context).getAnimations()) {
    ...
    public static Fragment getFragmentForNowplayingID(String fragmentID) {
        switch (fragmentID) {
            case Constants.BASEPLAYER1:
                return new BasePlayer1();
            case Constants.BASEPLAYER2:
                return new BasePlayer2();
            case Constants.BASEPLAYER3:
                return new BasePlayer3();
            case Constants.BASEPLAYER4:
                return new BasePlayer4();
            default:
                return new BasePlayer1();
        }
