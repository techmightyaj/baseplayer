...
public class Constants {
    ...
    public static final String BASEPLAYER1 = "baseplayer1";
    public static final String BASEPLAYER2 = "baseplayer2";
    public static final String BASEPLAYER3 = "baseplayer3";
    public static final String BASEPLAYER4 = "baseplayer4";
