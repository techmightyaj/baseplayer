...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        ImageLoader.getInstance().displayImage(BasePlayerUtils.getAlbumArtUri(localItem.id).toString(), itemHolder.albumArt,
                            ...
                            new Palette.Builder(loadedImage).generate(new Palette.PaletteAsyncListener() {
                                ...
                                public void onGenerated(Palette palette) {
                                    ...
                                    if (swatch != null) {
                                        ...
                                        int textColor = BasePlayerUtils.getBlackWhiteColor(swatch.getTitleTextColor());
                                        ...
                                        if (mutedSwatch != null) {
                                            ...
                                            itemHolder.footer.setBackgroundColor(color);
                                            int textColor = BasePlayerUtils.getBlackWhiteColor(mutedSwatch.getTitleTextColor());
                                            itemHolder.title.setTextColor(textColor);
                                            itemHolder.artist.setTextColor(textColor);
                                        }
                                    }
