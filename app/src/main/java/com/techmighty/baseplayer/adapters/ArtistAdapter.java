...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        String albumNmber = BasePlayerUtils.makeLabel(mContext, R.plurals.Nalbums, localItem.albumCount);
        String songCount = BasePlayerUtils.makeLabel(mContext, R.plurals.Nsongs, localItem.songCount);
        itemHolder.albums.setText(BasePlayerUtils.makeCombinedString(mContext, albumNmber, songCount));
