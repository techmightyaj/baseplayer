...
public class AlbumSongsAdapter extends RecyclerView.Adapter<AlbumSongsAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(ItemHolder itemHolder, int i) {
        ...
        itemHolder.duration.setText(BasePlayerUtils.makeShortTimeString(mContext, (localItem.duration) / 1000));
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    MusicPlayer.playAll(mContext, songIDs, getAdapterPosition(), albumID, BasePlayerUtils.IdType.Album, false);
