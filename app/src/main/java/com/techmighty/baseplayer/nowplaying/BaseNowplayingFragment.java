...
package com.techmighty.baseplayer.nowplaying;
...
import com.techmighty.baseplayer.adapters.BaseQueueAdapter;
import com.techmighty.baseplayer.dataloaders.QueueLoader;
import com.techmighty.baseplayer.listeners.MusicStateListener;
import com.techmighty.baseplayer.timely.TimelyView;
import com.techmighty.baseplayer.utils.Helpers;
import com.techmighty.baseplayer.utils.BasePlayerUtils;
import com.techmighty.baseplayer.widgets.CircularSeekBar;
import com.techmighty.baseplayer.widgets.DividerItemDecoration;
import com.techmighty.baseplayer.widgets.PlayPauseButton;
import com.techmighty.baseplayer.widgets.PlayPauseDrawable;
...
public class BaseNowplayingFragment extends Fragment implements MusicStateListener {
        ...
        public void run() {
            ...
            if (mProgress != null) {
                ...
                if (elapsedtime != null && getActivity() != null)
                    elapsedtime.setText(BasePlayerUtils.makeShortTimeString(getActivity(), position / 1000));
            }
    ...
    public Runnable mUpdateElapsedTime = new Runnable() {
        ...
        public void run() {
            if (getActivity() != null) {
                String time = BasePlayerUtils.makeShortTimeString(getActivity(), MusicPlayer.position() / 1000);
                if (time.length() < 5) {
    ...
    public void setSongDetails(View view) {
        ...
        if (playPauseFloating != null) {
            playPauseDrawable.setColorFilter(BasePlayerUtils.getBlackWhiteColor(accentColor), PorterDuff.Mode.MULTIPLY);
    ...
    public void updateSongDetails() {
        ...
        if (songduration != null && getActivity() != null)
            songduration.setText(BasePlayerUtils.makeShortTimeString(getActivity(), MusicPlayer.duration() / 1000));
