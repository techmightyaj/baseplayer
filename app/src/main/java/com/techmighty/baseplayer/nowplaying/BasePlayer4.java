...
import com.techmighty.baseplayer.adapters.BasePlayer4QueueAdapter;
import com.techmighty.baseplayer.dataloaders.QueueLoader;
import com.techmighty.baseplayer.utils.ImageUtils;

import net.steamcrafted.materialiconlib.MaterialDrawableBuilder;

public class BasePlayer4 extends BaseNowplayingFragment {

    ImageView mBlurredArt;
    RecyclerView horizontalRecyclerview;
    BasePlayer4QueueAdapter horizontalAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.fragment_baseplayer4, container, false);
    ...
    private void setupHorizontalQueue() {
        ...
        horizontalAdapter = new BasePlayer4QueueAdapter(getActivity(), QueueLoader.getQueueSongs(getActivity()));
