...
package com.techmighty.baseplayer;
...
import com.techmighty.baseplayer.helpers.MediaButtonIntentReceiver;
import com.techmighty.baseplayer.helpers.MusicPlaybackTrack;
import com.techmighty.baseplayer.permissions.Nammu;
import com.techmighty.baseplayer.provider.MusicPlaybackState;
import com.techmighty.baseplayer.provider.RecentStore;
import com.techmighty.baseplayer.provider.SongPlayCount;
import com.techmighty.baseplayer.utils.NavigationUtils;
import com.techmighty.baseplayer.utils.PreferencesUtility;
import com.techmighty.baseplayer.utils.BasePlayerUtils;
import com.techmighty.baseplayer.utils.BasePlayerUtils.IdType;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.techmighty.baseplayer.playstatechanged";
    public static final String POSITION_CHANGED = "com.techmighty.baseplayer.positionchanged";
    public static final String META_CHANGED = "com.techmighty.baseplayer.metachanged";
    public static final String QUEUE_CHANGED = "com.techmighty.baseplayer.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.techmighty.baseplayer.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.techmighty.baseplayer.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.techmighty.baseplayer.shufflemodechanged";
    public static final String TRACK_ERROR = "com.techmighty.baseplayer.trackerror";
    public static final String BASEPLAYER_PACKAGE_NAME = "com.techmighty.baseplayer";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.techmighty.baseplayer.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.techmighty.baseplayer.togglepause";
    public static final String PAUSE_ACTION = "com.techmighty.baseplayer.pause";
    public static final String STOP_ACTION = "com.techmighty.baseplayer.stop";
    public static final String PREVIOUS_ACTION = "com.techmighty.baseplayer.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.techmighty.baseplayer.previous.force";
    public static final String NEXT_ACTION = "fcom.techmighty.baseplayer.next";
    public static final String REPEAT_ACTION = "com.techmighty.baseplayer.repeat";
    public static final String SHUFFLE_ACTION = "com.techmighty.baseplayer.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.techmighty.baseplayer.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.techmighty.baseplayer.updatelockscreen";
    ...
    private static final String SHUTDOWN = "com.techmighty.baseplayer.shutdown";
    ...
    private int getCardId() {
        if (BasePlayerUtils.isMarshmallow()) {
    ...
    private void addToPlayList(final long[] list, int position, long sourceId, BasePlayerUtils.IdType sourceType) {
    ...
    private void doAutoShuffleUpdate() {
        ...
        for (int i = 0; i < toAdd; i++) {
            ...
            mPlaylist.add(new MusicPlaybackTrack(mAutoShuffleList[idx], -1, BasePlayerUtils.IdType.NA, -1));
            notify = true;
        }
        if (notify) {
            notifyChange(QUEUE_CHANGED);
    ...
    private void notifyChange(final String what) {
        ...
        musicIntent.setAction(what.replace(BASEPLAYER_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
    ...
    private void updateMediaSession(final String what) {
        ...
        if (what.equals(PLAYSTATE_CHANGED) || what.equals(POSITION_CHANGED)) {
            ...
            Bitmap albumArt = ImageLoader.getInstance().loadImageSync(BasePlayerUtils.getAlbumArtUri(getAlbumId()).toString());
            if (albumArt != null) {
    ...
    private Notification buildNotification() {
        ...
        Bitmap artwork;
        artwork = ImageLoader.getInstance().loadImageSync(BasePlayerUtils.getAlbumArtUri(getAlbumId()).toString());
        ...
        if (BasePlayerUtils.isJellyBeanMR1()) {
        ...
        if (artwork != null && BasePlayerUtils.isLollipop())
                ...
                do {
                    TrackItem t = new TrackItem()
                            .setArt(ImageLoader.getInstance()
                                    .loadImageSync(BasePlayerUtils.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(AudioColumns.ALBUM_ID))).toString()))
                            ...
                            .setDuration(BasePlayerUtils.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(AudioColumns.DURATION)) / 1000));
                    list.add(t.get());
                } while (c.moveToNext());
                try {
                ...
                try {
                    if (mCursor != null && shouldAddToPlaylist) {
                        ...
                        mPlaylist.add(new MusicPlaybackTrack(
                                mCursor.getLong(IDCOLIDX), -1, BasePlayerUtils.IdType.NA, -1));
                        notifyChange(QUEUE_CHANGED);
                        mPlayPos = 0;
                        mHistory.clear();
                    }
    ...
    public void open(final long[] list, final int position, long sourceId, BasePlayerUtils.IdType sourceType) {
        synchronized (this) {
            if (mShuffleMode == SHUFFLE_AUTO) {
