...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public BasePlayerUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, long sourceId, BasePlayerUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = BasePlayerUtils.IdType.getTypeById(in.readInt());
