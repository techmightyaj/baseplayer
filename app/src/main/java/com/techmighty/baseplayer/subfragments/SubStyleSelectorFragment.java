...
package com.techmighty.baseplayer.subfragments;
...
public class SubStyleSelectorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                styleImage.setImageResource(R.drawable.baseplayer_1_nowplaying_x);
                break;
            case 1:
                styleImage.setImageResource(R.drawable.baseplayer_2_nowplaying_x);
                break;
            case 2:
                styleImage.setImageResource(R.drawable.baseplayer_3_nowplaying_x);
                break;
            case 3:
                styleImage.setImageResource(R.drawable.baseplayer_4_nowplaying_x);
                break;
        }
    ...
    public void setCurrentStyle() {
        ...
        String fragmentID = preferences.getString(Constants.NOWPLAYING_FRAGMENT_ID, Constants.BASEPLAYER3);
    ...
    private String getStyleForPageNumber() {
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                return Constants.BASEPLAYER1;
            case 1:
                return Constants.BASEPLAYER2;
            case 2:
                return Constants.BASEPLAYER3;
            case 3:
                return Constants.BASEPLAYER4;
            default:
                return Constants.BASEPLAYER3;
        }
    }
