...
import com.techmighty.baseplayer.adapters.AlbumSongsAdapter;
import com.techmighty.baseplayer.dataloaders.AlbumLoader;
import com.techmighty.baseplayer.dataloaders.AlbumSongLoader;
import com.techmighty.baseplayer.listeners.SimplelTransitionListener;
import com.techmighty.baseplayer.models.Album;
import com.techmighty.baseplayer.models.Song;
import com.techmighty.baseplayer.utils.ATEUtils;
import com.techmighty.baseplayer.utils.Constants;
import com.techmighty.baseplayer.utils.FabAnimationUtils;
...
public class AlbumDetailFragment extends Fragment {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MusicPlayer.playAll(getActivity(), adapter.getSongIds(), 0, albumID, BasePlayerUtils.IdType.Album, true);
    ...
    private void setAlbumart() {
        ImageLoader.getInstance().displayImage(BasePlayerUtils.getAlbumArtUri(albumID).toString(), albumArt,
                new DisplayImageOptions.Builder().cacheInMemory(true)
                    ...
                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                        ...
                        MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(context)
                                ...
                                .setColor(BasePlayerUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                            ...
                            new Palette.Builder(loadedImage).generate(new Palette.PaletteAsyncListener() {
                                                                          ...
                                                                          public void onGenerated(Palette palette) {
                                                                              ...
                                                                              MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(getActivity())
                                                                                      ...
                                                                                      .setSizeDp(30);
                                                                              if (primaryColor != -1) {
                                                                                  builder.setColor(BasePlayerUtils.getBlackWhiteColor(primaryColor));
                                                                                  ATEUtils.setFabBackgroundTint(fab, primaryColor);
                                                                                  fab.setImageDrawable(builder.build());
                                                                              } else {
                                                                                  if (context != null) {
                                                                                      ATEUtils.setFabBackgroundTint(fab, Config.accentColor(context, Helpers.getATEKey(context)));
                                                                                      builder.setColor(BasePlayerUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                                      fab.setImageDrawable(builder.build());
                                                                                  }
                                                                              }
                                                                          }
    ...
    private void setAlbumDetails() {
        ...
        String songCount = BasePlayerUtils.makeLabel(getActivity(), R.plurals.Nsongs, album.songCount);
