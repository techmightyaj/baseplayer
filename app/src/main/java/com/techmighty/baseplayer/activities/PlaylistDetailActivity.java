...
import com.techmighty.baseplayer.dataloaders.LastAddedLoader;
import com.techmighty.baseplayer.dataloaders.PlaylistSongLoader;
import com.techmighty.baseplayer.dataloaders.SongLoader;
import com.techmighty.baseplayer.dataloaders.TopTracksLoader;
...
public class PlaylistDetailActivity extends BaseThemedActivity implements ATEActivityThemeCustomizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (BasePlayerUtils.isLollipop() && PreferencesUtility.getInstance(this).getAnimations()) {
    ...
    private void setAlbumart() {
        ...
        loadBitmap(BasePlayerUtils.getAlbumArtUri(getIntent().getExtras().getLong(Constants.ALBUM_ID)).toString());
    }
    ...
    private void setRecyclerViewAapter() {
        ...
        if (BasePlayerUtils.isLollipop() && PreferencesUtility.getInstance(mContext).getAnimations()) {
